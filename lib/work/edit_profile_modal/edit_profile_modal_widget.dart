...
class _EditProfileModalWidgetState extends State<EditProfileModalWidget>
  ...
  void initState() {
    ...
    _model.yourNameTextController ??=
        TextEditingController(text: FFAppState().userDisplayName);
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (selectedMedia != null &&
                                          ...
                                          try {
                                            ...
                                            _model.isDataUploading_uploadDataVt9 =
                                                false;
                                          }
                                          if (selectedUploadedFiles.length ==
                                              ...
                                              downloadUrls.length ==
                                                  selectedMedia.length) {
                                            safeSetState(() {
                                              _model.uploadedLocalFile_uploadDataVt9 =
                                                  selectedUploadedFiles.first;
                                              _model.uploadedFileUrl_uploadDataVt9 =
                                                  downloadUrls.first;
                                            });
                                          } else {
                                            safeSetState(() {});
