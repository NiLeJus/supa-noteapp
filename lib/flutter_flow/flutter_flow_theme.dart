...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6CAEEC);
  late Color secondary = const Color(0xFF9A94BC);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFD9FFF5);
  ...
  late Color accent3 = const Color(0xFFEFF3DD);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF8EFFA4);
