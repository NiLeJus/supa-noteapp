...
import 'auth_flow_model.dart';
export 'auth_flow_model.dart';

class AuthFlowWidget extends StatefulWidget {
  const AuthFlowWidget({super.key});

  static String routeName = 'Auth_Flow';
  static String routePath = '/authFlow';
...
class _AuthFlowWidgetState extends State<AuthFlowWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthFlowModel());
